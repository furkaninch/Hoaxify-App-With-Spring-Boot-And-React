...
public class FileTypeValidator implements ConstraintValidator<FileType,String>{
	...
	public boolean isValid(String image, ConstraintValidatorContext context) {
		...
		HibernateConstraintValidatorContext hibernateConstraint =
				context.unwrap(HibernateConstraintValidatorContext.class);
		hibernateConstraint.addMessageParameter("types", supportedTypes);
		hibernateConstraint.buildConstraintViolationWithTemplate(context.getDefaultConstraintMessageTemplate())
